...
module load R
cd /bio/krthornt/Nc100.N500/s0.05
...
~/src/forward_src/expevol_region_breakpoints /kevin/krthornt/expevol_project/coalescent/macfile.$SGE_TASK_ID.gz 100 500 0.05 0.5 0.025 100 500 1000 25 25 summary.$SGE_TASK_ID.gz out.$SGE_TASK_ID $SEED
